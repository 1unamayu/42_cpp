...
void Contact::setFirstName(void) {
    ...
    while (1) {
        ...
        std::cout << "\033[0;31mFirst name cannot be empty.\033[0;37m"
                  << std::endl;
    }
}
...
void Contact::setLastName(void) {
    ...
    while (1) {
        ...
        std::cout << "\033[0;31mLast name cannot be empty.\033[0;37m"
                  << std::endl;
    }
}
...
void Contact::setNickname(void) {
    ...
    while (1) {
        ...
        std::cout << "\033[0;31mNickname cannot be empty.\033[0;37m"
                  << std::endl;
    }
}
...
void Contact::printContact(void) {
    ...
    std::cout << KYEL "  Phone number: " KNOR << this->_phoneNumber
              << std::endl;
